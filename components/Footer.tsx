      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex flex-wrap justify-center gap-3 mb-6">
          <a
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm text-rb-gray dark:text-gray-300 hover:text-rb-blue transition"
          >
        ...
        {/* Privacy Reassurance */}
        <div className="text-center mb-6">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-full mb-3">
          ...
          <p className="text-sm text-rb-gray dark:text-gray-300 max-w-md mx-auto">
        ...
        <div className="flex items-center justify-center gap-4 text-xs text-gray-400 dark:text-gray-300">
          <span>© {new Date().getFullYear()} RecoveryBridge LLC. All rights reserved.</span>
          <ThemeToggle />
        </div>
      </div>
    </footer>
...
export function PrivacyBadge({ className = '' }: { className?: string }) {
  return (
    <div className={`inline-flex items-center gap-2 px-3 py-1.5 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-full ${className}`}>
      ...
      <span className="text-xs sm:text-sm font-medium text-green-900 dark:text-green-200">
...
export function CompactFooter({ className = '' }: FooterProps) {
  return (
    <footer className={`mt-6 py-4 px-4 text-center ${className}`}>
      <div className="flex flex-wrap justify-center items-center gap-2 text-xs text-rb-gray dark:text-gray-300 mb-2">
        ...
        <span>•</span>
        <span className="text-gray-400 dark:text-gray-300">🔒 Private & Confidential</span>
      </div>
    </footer>
  )
}
