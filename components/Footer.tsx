      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex flex-wrap justify-center gap-3 mb-6">
          <a
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm text-rb-gray dark:text-gray-400 hover:text-rb-blue transition"
          >
        ...
        <div className="text-center mb-4">
          <div className="inline-flex flex-wrap justify-center items-center gap-x-3 gap-y-2 text-sm text-rb-gray dark:text-gray-400">
            <a
              href="/privacy"
...
export function CompactFooter({ className = '' }: FooterProps) {
  return (
    <footer className={`mt-6 py-4 px-4 text-center ${className}`}>
      <div className="flex flex-wrap justify-center items-center gap-2 text-xs text-rb-gray dark:text-gray-400 mb-2">
