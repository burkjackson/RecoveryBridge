  ...
  return (
    <main id="main-content" className="min-h-screen flex flex-col bg-[#F8F9FA] dark:bg-gray-900">
      ...
      <div className="flex-1 w-full max-w-4xl mx-auto px-4 sm:px-6 py-10 sm:py-14">
        ...
        >
          RecoveryBridge is peer support, not emergency or medical care. In a crisis, <a href="sms:988" className="underline font-semibold">text</a> or <a href="tel:988" className="underline font-semibold">call</a> 988, text{' '}
