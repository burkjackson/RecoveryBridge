...
export const faqs: Faq[] = [
  {
    ...
    a: "RecoveryBridge is peer support — not emergency services or crisis intervention. If you're in immediate danger, please reach out: text or call 988 (Suicide & Crisis Lifeline), text HOME to 741741 (Crisis Text Line), or call 911. These resources are always one tap away inside the app.",
  },
  {
    q: 'Is it anonymous?',
